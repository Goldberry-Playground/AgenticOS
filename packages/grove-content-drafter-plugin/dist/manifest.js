...
var manifest = {
  ...
  description: "Drafts nursery listing content (storefront description + cited care guide) from the recorded plant facts (GOL-2384).",
  author: "AgenticOS",
  ...
  instanceConfigSchema: {
    ...
    properties: {
      ...
      houseRules: {
        type: "string",
        title: "House rules",
        description: "Authoritative editorial rules from the vault (e.g. juglone: minor factor, never 'poison'). Injected into the system prompt.",
        default: ""
      },
      dryRun: {
        type: "boolean",
        title: "Dry run (no writes)",
        description: "When true (default), the job reads + drafts + logs but does NOT write back or change draft state. Josh flips this off to go live on QA.",
        default: true
      }
    },
