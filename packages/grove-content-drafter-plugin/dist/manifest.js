...
var manifest = {
  ...
  jobs: [
    ...
    },
    {
      ...
      description: "Every 20 min: apply any drafting-agent reply the event missed, and re-ping / give up on overdue requests.",
      schedule: "*/20 * * * *"
    }
  ],
  instanceConfigSchema: {
    ...
    properties: {
      ...
      houseRules: {
        type: "string",
        title: "House rules",
        description: "Authoritative editorial rules from the vault (e.g. juglone: minor factor, never 'poison'). Injected into the system brief.",
        default: ""
      },
      companyId: {
        type: "string",
      ...
      drafterAgentId: {
        ...
        description: "UUID of the agent that writes the drafts on the Claude subscription. Its comments are the only ones the receive phase reads.",
      ...
      dryRun: {
        ...
        description: "When true (default), the receive phase validates + logs the draft but does NOT write it to Odoo. Josh flips this off to go live on QA.",
        default: true
      },
      unusedSecretRef: {
        type: "string",
